...
export function FeedbackSuccessStep(props: IFeedbackSuccessStepProps){
    return (
        <>
            ...
            <button type="button" className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors" onClick={props.onFbRestarted}>
                Enviar outro
            </button>
            </div>
        </>
